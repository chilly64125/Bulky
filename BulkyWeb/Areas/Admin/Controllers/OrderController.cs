...
namespace BulkyBookWeb.Areas.Admin.Controllers {
	...
	public class OrderController : Controller {
        ...
        [BindProperty]
        public OrderVM OrderVM { get; set; } = new OrderVM { OrderHeader = new OrderHeader() };
        ...
        public IActionResult StartProcessing() {
            if (OrderVM.OrderHeader == null) return BadRequest();
        ...
        public IActionResult Details_PAY_NOW() 
        {
            ...
            foreach (var item in OrderVM.OrderDetail ?? Enumerable.Empty<OrderDetail>()) {
        ...
        public IActionResult PaymentConfirmation(int orderHeaderId) {
            ...
            if (orderHeader == null) return View(orderHeaderId);
            if (orderHeader.PaymentStatus == SD.PaymentStatusDelayedPayment) {
		...
		public IActionResult GetAll(string status) {
            ...
            if(User.IsInRole(SD.Role_Admin)|| User.IsInRole(SD.Role_Employee)) {
                ...
                {
                    objOrderHeaders = Enumerable.Empty<OrderHeader>();
                }
                else
                {
